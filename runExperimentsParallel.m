...
function packageList = createWorkpackages()
    ...
    for alg = [ ..."SRXD", "SRXS", ...
            ...
            "Alternating1HHX", "Alternating2HHX", ...
        ...
        for pro = ["RM1", "RM2", "RM3", "RM4", "DTLZ1", "DTLZ2", "DTLZ3", "DTLZ4", "DTLZ5","DTLZ6", "DTLZ7", "DTLZ8", "DTLZ9", "WFG1", "WFG2", "WFG3", "WFG4", "WFG5", "WFG6", "WFG7", "WFG8", "WFG9"]
            for r = 1:numberOfRuns
                packageList = [packageList; struct('alg', alg + "NSGAII", 'pro', pro, 'runNo', r, 'MMulti', 1, 'DMulti', 4, 'MaxFE', 10000, 'savePath', 'AlternativeAlgs4Harder')];
            end
        end
    end
end
