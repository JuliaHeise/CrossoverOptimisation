...
function packageList = createWorkpackages()
    numberOfRuns = 31;
    packageList = [];
    %Selection Algorithm tuned
    for alg = ["EP5", "EP7", "LINEAR", "LOGISTIC", "MINR0", "MINR5", "RR10", "RR5", "XOP16", "XOP3"]
        for pro = ["RM1", "RM2", "RM3", "RM4", "DTLZ1", "DTLZ2", "DTLZ3", "DTLZ4", "DTLZ5","DTLZ6", "DTLZ7", "DTLZ8", "DTLZ9", "WFG1", "WFG2", "WFG3", "WFG4", "WFG5", "WFG6", "WFG7", "WFG8", "WFG9"]
            for r = 1:numberOfRuns
                packageList = [packageList; struct('alg', alg + "_NCRXSNSGAII", 'pro', pro, 'runNo', r, 'MMulti', 1, 'DMulti', 4, 'MaxFE', 10000, 'savePath', 'Exp3')];
            end
        end
    end
    
    %Distribution Algorithm tuned
    for alg = ["LINEAR", "LOGISTIC", "LOS", "XOP16", "XOP3"]
        for pro = ["RM1", "RM2", "RM3", "RM4", "DTLZ1", "DTLZ2", "DTLZ3", "DTLZ4", "DTLZ5","DTLZ6", "DTLZ7", "DTLZ8", "DTLZ9", "WFG1", "WFG2", "WFG3", "WFG4", "WFG5", "WFG6", "WFG7", "WFG8", "WFG9"]
            for r = 1:numberOfRuns
                packageList = [packageList; struct('alg', alg + "_SRXDNSGAII", 'pro', pro, 'runNo', r, 'MMulti', 1, 'DMulti', 4, 'MaxFE', 10000, 'savePath', 'Exp3')];
            end
        end
    end
end
